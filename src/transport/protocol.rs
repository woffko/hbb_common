...
impl MessageType {
    pub fn channel(self) -> ChannelId {
        match self {
            ...
            Self::ReliableVideoFrame => ChannelId::ReliableVideo,
    ...
    pub fn max_payload_len(self) -> usize {
        match self {
            ...
            Self::ReliableVideoFrame => 32 * 1024 * 1024,
